## Create VCN and Deploy MySQL InnoDB Cluster on OCI using multiple Availability Domains (non free trier)
...
![MySQL InnoDB Cluster architecture](examples/multiple_ad/images/oci_multi_ad.png)
